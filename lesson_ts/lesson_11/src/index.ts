...
import IPaymentProvider from "./Adapter/IPaymentProvider.js";
...
import ICoffee from "./Decorator/interfaces/ICoffee.js";
...
import {
  ...
  settings,
  TruckFactory,
} from "./Factory Method/VehicleFactory.js";
...
function LearningUIFactoryFn(factory: ILearningUIFactory) {
...
const player1 = new GameCharacter(
  "Ivan",
  3,
  ["speed", "strong"],
  ["sword", "shield"]
...
function paymentServise(provider: IPaymentProvider, amount: number): void {
  provider.pay(amount);
}
