...
import PieChart from "./task_2/typeChart/PieChart.js";
import IGetValue from "./task_3/interfaces/IGetValue.js";
import ISwitcher from "./task_3/interfaces/ISwitch.js";
import Sensor from "./task_3/Sensor.js";
import CheckingAccount from "./task_4/CheckingAccount.js";
import LoanAccount from "./task_4/LoanAccount.js";
import SavingsAccount from "./task_4/SavingsAccount.js";
import PageRenderer from "./task_5/PageRenderer.js";
import HTMLTemplateRenderer from "./task_5/renderers/HTMLTemplateRenderer.js";
import Markdown from "./task_5/renderers/Markdown.js";
import PDF from "./task_5/renderers/PDF.js";

const task1 = new ImageUploader();
task1.uploadImage(
...
const task2 = new ChartRenderer(new PieChart(data));
task2.render(data);
console.log("===============================================");
// const task_3 = new Sensor();
const sensors: (IGetValue & ISwitcher)[] = [new Sensor(), new Sensor()];
...
console.log(loan.getLoanBalance());
console.log("===============================================");

const htmlPage = new PageRenderer(new HTMLTemplateRenderer());
htmlPage.renderPage("Hello world");

const mdPage = new PageRenderer(new Markdown());
mdPage.renderPage("Hello world");

const pdfPage = new PageRenderer(new PDF());
pdfPage.renderPage("Hello world");
